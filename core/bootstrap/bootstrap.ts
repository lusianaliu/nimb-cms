...
import { ContentRegistry, ContentStore, ContentQueryService, ContentCommandService, EntryRegistry, createContentTypeRegistry, createFieldTypeRegistry, registerDefaultFieldTypes, type ContentEvents } from '../content/index.ts';
import { post, page, media } from '../content/builtin/index.ts';
...
export const createBootstrap = async ({
  ...
  runtime.contentTypes.register(post);
  runtime.contentTypes.register(page);
  runtime.contentTypes.register(media);
  ...
  const adminMenuRegistry = createAdminMenuRegistry();
  ...
  await runtime.hooks.run('content.field', runtime.fieldTypes);
